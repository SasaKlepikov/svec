...
function cdhl_shortcode_ourclients($atts) {
	...
	ob_start();
	?>
	<div id="cd_ourclients_<?php echo esc_attr($element_id);?>" class="<?php echo esc_attr($element_classes);?>">
        <div class="col-lg-12 col-md-12">
          <?php
          if($list_style=="with_slider"){
          ?>
            <div class="owl-carousel" 
			data-nav-arrow='<?php esc_attr_e($arrow)?>' 
			data-nav-dots='<?php esc_attr_e($dots)?>' 
			data-items='<?php esc_attr_e($data_md_items)?>' 
			...
			data-loop='<?php esc_attr_e($data_loop)?>'>
                ...
                foreach ($imagesurl as $image_id) {
                    ...
                    <?php
                    $k++;
                    if($k % $number_of_column == 0 || $k == $slider_images){									
                    ?>
                    </div>
                    <?php
                    }
