                          ...
                          <div class="blog-content">
                            <div class="blog-admin-main">
                             ...
                             <?php echo get_avatar( get_the_author_meta( 'ID' ), 32 ); ?>
                              <span><?php echo esc_html__('By','cardealer-helper').' '.get_the_author();?></span>
                             </div>
                             <div class="blog-meta pull-right">
                               <ul>
                                 <li>
									<a href="<?php echo esc_url( get_comments_link(get_the_ID()) )?>"> <i class="fa fa-comment"></i><br /> 
										<?php $comments_count = wp_count_comments(get_the_ID()); echo esc_html($comments_count->total_comments);?>
									</a>
								</li>
								 <?php
									global $car_dealer_options;
									...
									$linkedin_share   = isset($car_dealer_options['twitter_share']) ? $car_dealer_options['twitter_share'] : ''; 
									...
									<li class="share"><a href="#"> <i class="fa fa-share-alt"></i><br /> ...</a>
										<div class="blog-social"> 
											...
											<?php }
												if($pinterest_share){?>
												<li>
													<a href="#"  data-title="<?php echo esc_attr(get_the_title())?>" data-url="<?php echo esc_url(get_permalink())?>" data-image="<?php the_post_thumbnail_url('full')?>" class="pinterest-share"><i class="fa fa-pinterest-p"></i></a>
												</li>
											<?php }
												?>
											</ul>
