...
class CarDealer_Helper_Widget_Newsletter extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<div class="news-letter">		
			...
			<form class="news-letter" id="<?php echo esc_attr($widget_form_id)?>">					
				<input type="hidden" class="news-nonce" name="news_nonce" value="<?php echo wp_create_nonce("mailchimp_news");?>">
	...
	public function form( $instance ) {
        ...
        <p>
			<?php
            echo sprintf(wp_kses( __( 'Enter description. Please ensure to add short content.<br>
                    <strong>Note:</strong> Please set both your MailChimp API key and list id in the API Keys panel. <a href="%1$s" target="_blank">Add API key here</a>', 'cardealer-helper'),
    					array(
                            'br' => array(),
                            'strong' => array(),
    						'a' => array(
