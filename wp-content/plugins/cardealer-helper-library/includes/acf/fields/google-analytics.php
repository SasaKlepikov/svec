...
acf_add_local_field_group(array (
	...
	'fields' => array (
		...
		array (
			...
			'name' => 'key_file',
			'type' => 'file',
			'instructions' => sprintf( wp_kses( __('<strong>Key file</strong> generated from <strong><a href="%1$s" target="_blank">service account</a></strong> with <strong>.json</strong> extension. Make sure you upload file in <strong>JSON</strong> format only. For more information, please check <strong>Car Dealer <a href="%2$s" target="_blank">dashboard documentation</a></strong> google analytics section.', 'cardealer-helper'), array( 'strong'=> array(), 'a'=> array( 'href'=> array(), 'target'=> array() ) ) ), esc_url('https://console.developers.google.com/permissions/serviceaccounts'), esc_url('http://docs.potenzaglobalsolutions.com/docs/cardealer/extra/dashboard') ),
			'required' => 1,
			'conditional_logic' => 0,
			'wrapper' => array (
				'width' => '',
