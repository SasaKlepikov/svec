...
acf_add_local_field_group(apply_filters('cardealer_acf_vehicle_review_stamps', array (
	...
	'fields' => array (
		...
		array (
			...
			'name' => 'url',
			'type' => 'url',
			'instructions' => sprintf( esc_html__('Pass {{vin}} in to the link it will replace with real VIN number 
e.g. %1$s', 'cardealer-helper'), esc_url('http://www.carfax.com/Report.cfx?vin=').'{{vin}}' ),
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array (
				'width' => '',
