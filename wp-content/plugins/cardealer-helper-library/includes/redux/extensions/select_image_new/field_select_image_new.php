    ...
    class ReduxFramework_select_image_new {
        ...
        function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                // Process placeholder
                $placeholder = ( isset( $this->field['placeholder'] ) ) ? esc_attr( $this->field['placeholder'] ) : esc_html__( 'Select an item', 'constro' );
                ...
                echo '<strong>' . esc_html__( 'No items of this type were found.', 'constro' ) . '</strong>';
            }
        } //function
        ...
        function enqueue() {
            ...
            wp_enqueue_script(
                ...
                $this->extension_url . '/field_select_image_new' . Redux_Functions::isMin() . '.js',
            ...
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    ...
                    $this->extension_url . '/field_select_image_new.css',
                    array(),
                    time(),
                    'all'
                );
