...
class ComposerAutoloaderInit385b81b594b8370645f7d3a89cc12586
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit385b81b594b8370645f7d3a89cc12586::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire385b81b594b8370645f7d3a89cc12586($fileIdentifier, $file);
        }
...
function composerRequire385b81b594b8370645f7d3a89cc12586($fileIdentifier, $file)
{
