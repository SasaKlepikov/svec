<?php
if( ! defined( 'CDHL_VC_DIR' ) ) define( 'CDHL_VC_DIR', trailingslashit(CDHL_PATH) . 'includes/vc' );
if( ! defined( 'CDHL_VC_URL' ) ) define( 'CDHL_VC_URL', trailingslashit(CDHL_URL) . 'includes/vc' );
...
//cardealer_helper_vc_param_loader();
