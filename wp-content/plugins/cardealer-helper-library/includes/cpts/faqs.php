...
function cdhl_cpt_faq() {
	$labels = array(
		'name'               => esc_html_x( 'Faqs', 'post type general name', 'cardealer-helper' ),
		'singular_name'      => esc_html_x( 'Faq', 'post type singular name', 'cardealer-helper' ),
		'menu_name'          => esc_html_x( 'Faqs', 'admin menu', 'cardealer-helper' ),
		'name_admin_bar'     => esc_html_x( 'Faq', 'add new on admin bar', 'cardealer-helper' ),
		'add_new'            => esc_html_x( 'Add New', 'faqs', 'cardealer-helper' ),
