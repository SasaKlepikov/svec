...
function cdhl_cpt_team() {
	$labels = array(
		'name'                 => esc_html_x( 'Teams', 'post type general name', 'cardealer-helper' ),
		'singular_name'        => esc_html_x( 'Team', 'post type singular name', 'cardealer-helper' ),
		'menu_name'            => esc_html_x( 'Teams', 'admin menu', 'cardealer-helper' ),
		'name_admin_bar'       => esc_html_x( 'Team', 'add new on admin bar', 'cardealer-helper' ),
		'add_new'              => esc_html_x( 'Add New', 'teams', 'cardealer-helper' ),
 ...
 * Edit columns
 */
function cdhl_cpt_teams_edit_columns($columns)
{
	$newcolumns = array(
