        ...
        <div class="car-item gray-bg text-center <?php echo cardealer_cars_loop();?>">
            <div class="car-image">            
                ...
                <div class="car-overlay-banner">
                    <ul> 
                        <li><a href="<?php echo get_the_permalink($id);?>" data-toggle="tooltip" title="<?php esc_attr_e('View','cardealer')?>"><i class="fa fa-link"></i></a></li>
						<?php
							if(isset($carInCompare) && !empty($carInCompare) && in_array($id, $carInCompare))
							{
								...
								if($cars)
								?>
								<li><a href="javascript:void(0)" data-toggle="tooltip" title="<?php esc_attr_e('Compare','cardealer')?>" class="compare_pgs compared_pgs" data-id="<?php echo esc_attr($id);?>"><i class="fa fa-check"></i></a></li> 
							<?php
							} else {
							?>
								<li><a href="javascript:void(0)" data-toggle="tooltip" title="<?php esc_attr_e('Compare','cardealer')?>" class="compare_pgs" data-id="<?php echo esc_attr( $id );?>"><i class="fa fa-exchange"></i></a></li>
							<?php
							}
							$images = cardealer_get_images_url('car_catalog_image',$id); 
							if(!empty($images)){?>	
							<li class="pssrcset"><a href="javascript:void(0)" data-toggle="tooltip" title="<?php esc_attr_e('Gallery','cardealer')?>" class="psimages" data-image="<?php echo implode(", ",$images); ?>"><i class="fa fa-expand" ></i></a></li>
							<?php }?>
					</ul>
                </div>
            ...
            <div <?php cardealer_list_view_class_1()?>>
                <div class="car-item gray-bg text-center">
                    <div class="car-image">
                        ...
                        <div class="car-overlay-banner">
                            <ul> 
                                <li><a href="<?php echo get_the_permalink();?>" data-toggle="tooltip" title="<?php esc_attr_e('View','cardealer')?>"><i class="fa fa-link"></i></a></li>
                                <?php
									if(isset($carInCompare) && !empty($carInCompare) && in_array($id, $carInCompare))
									{
										$cars = json_decode($_COOKIE['cars']);
