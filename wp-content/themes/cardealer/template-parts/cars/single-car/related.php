                            ...
                            <div class="car-item gray-bg text-center">
                                <div class="car-image">
                                    ...
                                    <div class="car-overlay-banner">
                                        <ul> 
                                            <li><a href="<?php echo esc_url(get_the_permalink());?>" data-toggle="tooltip" title="<?php esc_attr_e('View','cardealer')?>"><i class="fa fa-link"></i></a></li>                                            
                                            <?php
    											if(isset($carInCompare) && !empty($carInCompare) && in_array(get_the_ID(), $carInCompare))
    											{
    												$cars = json_decode($_COOKIE['cars']);
    											?>
    												<li><a href="javascript:void(0)" class="compare_pgs compared_pgs" data-id="<?php echo get_the_ID();?>" data-toggle="tooltip" title="<?php esc_attr_e('Compare','cardealer')?>"><i class="fa fa-check"></i></a></li> 
    											<?php
    											} else {
    											?>
    												<li><a href="javascript:void(0)" class="compare_pgs" data-id="<?php echo get_the_ID();?>" data-toggle="tooltip" title="<?php esc_attr_e('Compare','cardealer')?>"><i class="fa fa-exchange"></i></a></li>
    											<?php
    											}
    										?>
                                        </ul>
