		...
		if( isset($car_dealer_options['financial_form']) && !empty($car_dealer_options['financial_form']) && $car_dealer_options['financial_form_contact_7'] == true ) {
    		...
    		<form name="financial_form" class="gray-form" method="post" id="financial_form">
        		...
        		<div class="selected-box">
        			<select class="selectpicker cdhl_sel_validate" name="state" id="state" >
        		...
        		<div class="col-sm-4">
        		<div class="selected-box">
        			<select class="selectpicker cdhl_sel_validate" name="date_of_birth_month" id="date_of_birth_month" >
        		...
        		<div class="col-sm-4">
        		<div class="selected-box">
        			<select class="selectpicker cdhl_sel_validate" name="date_of_birth_day" id="date_of_birth_day" >
        		...
        		<div class="col-sm-4">
        		<div class="selected-box">
        			<select class="selectpicker cdhl_sel_validate" name="date_of_birth_year" id="date_of_birth_year" >
        		...
        		<input type="text" name="social_security_number" class="form-control cdhl_validate" id="social_security_number" maxlength="15"/>
        		</div>
        		</div>
        		...
        		<div class="selected-box">
        			<select class="selectpicker cdhl_sel_validate" name="living_arrangements" id="living_arrangements" >
        			<option value=""><?php esc_html_e( 'Select One', 'cardealer' );?></option>
        		...
        		<div class="col-sm-6">
        		<div class="selected-box">
        			<select class="selectpicker cdhl_sel_validate" name="length_of_time_at_current_add_year" id="length_of_time_at_current_add_year" >
        		...
        		<div class="col-sm-6">
        		<div class="selected-box">
        			<select class="selectpicker  cdhl_sel_validate" name="length_of_time_at_current_add_month" id="length_of_time_at_current_add_month" >
        		...
        		<div class="col-sm-6">
        		<div class="selected-box">
        			<select class="selectpicker cdhl_sel_validate" name="length_of_employment_year" id="length_of_employment_year" >
        			<option value=""><?php esc_html_e( 'Year(s)', 'cardealer' );?></option>
        			<option value="<?php esc_attr_e( '1 Year', 'cardealer' );?>"><?php esc_html_e( '1 Year', 'cardealer' );?></option>
        			<?php for($i=2;$i<31;$i++){ ?>
        			<option value="<?php echo esc_attr__( $i .' Years' , 'cardealer' );?>"><?php echo esc_html__( $i .' Years', 'cardealer' );?></option>
        		...
        		<div class="col-sm-6">
        		<div class="selected-box">
        			<select class="selectpicker cdhl_sel_validate" name="length_of_employment_month" id="length_of_employment_month" >
        			<option value=""><?php esc_html_e( 'Month(s)', 'cardealer' );?></option>
        			<option value="<?php esc_attr_e( '1 Month', 'cardealer' );?>"><?php esc_html_e( '1 Month', 'cardealer' );?></option>
        			<?php for($i=2;$i<12;$i++){ ?>
        			<option value="<?php echo esc_attr__( $i .' Months' , 'cardealer' );?>"><?php echo esc_html__( $i .' Months', 'cardealer' );?></option>
			...
			<div id="personal_application">
        		...
        		<label><?php esc_html_e( 'State', 'cardealer' );?>*</label>
        		<div class="selected-box">
        			<select class="selectpicker cdhl_sel_validate_joint" name="state_joint" id="state_joint" >
        			<option value=""><?php esc_html_e( 'Select One:', 'cardealer' );?></option>
        			<option value="alabama"><?php esc_html_e( 'Alabama', 'cardealer' );?></option>
        			<option value="alaska"><?php esc_html_e( 'Alaska', 'cardealer' );?></option>
        			<option value="arizona"><?php esc_html_e( 'Arizona', 'cardealer' );?></option>
        		...
        		<div class="col-sm-4">
        		<div class="selected-box">
        			<select class="selectpicker cdhl_sel_validate_joint" name="date_of_birth_month_joint" id="date_of_birth_month_joint" >
        			<option value=""><?php esc_html_e( 'Month', 'cardealer' );?></option>
        			<?php for($i=01;$i<13;$i++){ ?>
        			<option value="<?php echo esc_attr($i);?>"><?php echo esc_html($i);?></option>
        			<?php } ?>
        		...
        		<div class="col-sm-4">
        		<div class="selected-box">
        			<select class="selectpicker cdhl_sel_validate_joint" name="date_of_birth_day_joint" id="date_of_birth_day_joint" >
        			<option value=""><?php esc_html_e( 'Day', 'cardealer' );?></option>
        			<?php for($i=01;$i<32;$i++){ ?>
        			<option value="<?php echo esc_attr($i);?>"><?php echo esc_html($i);?></option>
        			<?php } ?>
        		...
        		<div class="col-sm-4">
        		<div class="selected-box">
        			<select class="selectpicker cdhl_sel_validate_joint" name="date_of_birth_year_joint" id="date_of_birth_year_joint" >
        			<option value=""><?php esc_html_e( 'Year', 'cardealer' );?></option>
        			<?php for($i=1925;$i<2018;$i++){ ?>
        			<option value="<?php echo esc_attr($i);?>"><?php echo esc_html($i);?></option>
        			<?php } ?>
        		...
        		<div class="form-group">
        		<label><?php esc_html_e( 'Social Security Number (SSN)', 'cardealer' );?>*</label>
        		<input type="text" name="social_security_number_joint" class="form-control cdhl_validate_joint" id="social_security_number_joint" maxlength="15"/>
        		</div>
        		</div>
        		...
        		<label><?php esc_html_e( 'Living Arrangements', 'cardealer' );?>*</label>
        		<div class="selected-box">
        			<select class="selectpicker cdhl_sel_validate_joint" name="living_arrangements_joint" id="living_arrangements_joint" >
        			<option value=""><?php esc_html_e( 'Select One', 'cardealer' );?></option>
        			<option value="rent"><?php esc_html_e( 'Rent', 'cardealer' );?></option>
        			<option value="own"><?php esc_html_e( 'Own', 'cardealer' );?></option>
        			<option value="live_with_parents"><?php esc_html_e( 'Live With Parents', 'cardealer' );?></option>
        		...
        		<div class="col-sm-6">
        		<div class="selected-box">
        			<select class="selectpicker cdhl_sel_validate_joint" name="length_of_time_at_current_add_year_joint" id="length_of_time_at_current_add_year_joint" >
        			<option value=""><?php esc_html_e( 'Year(s)', 'cardealer' );?></option>
        			<option value="<?php esc_attr_e( '1 Year', 'cardealer' );?>"><?php esc_html_e( '1 Year', 'cardealer' );?></option>
        			<?php for($i=2;$i<31;$i++){ ?>
        			<option value="<?php echo esc_attr__( $i . ' Years' , 'cardealer' );?>"><?php echo esc_html__( $i . ' Years', 'cardealer' );?></option>
        		...
        		<div class="col-sm-6">
        		<div class="selected-box">
        			<select class="selectpicker cdhl_sel_validate_joint" name="length_of_time_at_current_add_month_joint" id="length_of_time_at_current_add_month_joint" >
        			<option value=""><?php esc_html_e( 'Month(s)', 'cardealer' );?></option>
        			<option value="<?php esc_attr_e( '1 Month', 'cardealer' );?>"><?php esc_html_e( '1 Month', 'cardealer' );?></option>
        			<?php for($i=2;$i<12;$i++){ ?>
        			<option value="<?php echo esc_attr__( $i . ' Months' , 'cardealer' );?>"><?php echo esc_html__( $i . ' Months', 'cardealer' );?></option>
        		...
        		<div class="col-sm-6">
        		<div class="selected-box">
        			<select class="selectpicker cdhl_sel_validate_joint" name="length_of_employment_year_joint" id="length_of_employment_year_joint" >
        			<option value=""><?php esc_html_e( 'Year(s)', 'cardealer' );?></option>
        			<option value="<?php esc_attr_e( '1 Year', 'cardealer' );?>"><?php esc_html_e( '1 Year', 'cardealer' );?></option>
        			<?php for($i=2;$i<31;$i++){ ?>
        			<option value="<?php echo esc_attr__( $i . ' Years' , 'cardealer' );?>"><?php echo esc_html__( $i . ' Years', 'cardealer' );?></option>
        		...
        		<div class="col-sm-6">
        		<div class="selected-box">
        			<select class="selectpicker cdhl_sel_validate_joint" name="length_of_employment_month_joint" id="length_of_employment_month_joint" >
        			<option value=""><?php esc_html_e( 'Month(s)', 'cardealer' );?></option>
        			<option value="<?php esc_attr_e( '1 Month', 'cardealer' );?>"><?php esc_html_e( '1 Month', 'cardealer' );?></option>
        			<?php for($i=2;$i<12;$i++){ ?>
        			<option value="<?php echo esc_attr__( $i . ' Months' , 'cardealer' );?>"><?php echo esc_html__( $i . ' Months', 'cardealer' );?></option>
